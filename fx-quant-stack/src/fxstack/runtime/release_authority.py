...
_EXECUTION_SEMANTIC_FIELDS = (
    ...
    "production_scalp_demo_probe_id",
    "production_scalp_demo_probe_symbol",
    "production_scalp_demo_probe_side",
...
_NON_EXECUTION_PUBLIC_FIELDS = frozenset(
    {
        ...
        "production_scalp_validation_bundle",
        "production_scalp_verify_key_file",
        "registry_root",
        "rl_artifact_root",
        "rl_stress_root",
