...
"%TRADER_PYTHON_EXE%" "%ROOT%\fx-quant-stack\scripts\train_deep_stale.py" --swing-timeframe D --intraday-timeframe M5 --feature-root "%FXSTACK_TRAIN_FEATURE_ROOT%" --label-root "%FXSTACK_TRAIN_LABEL_ROOT%" --artifact-root "%FXSTACK_TRAIN_ARTIFACT_ROOT%" --stale-hours %FXSTACK_DEEP_MODEL_STALE_HOURS%
if errorlevel 1 (
