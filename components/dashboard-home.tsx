    ...
    <div className="space-y-6">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-base text-muted-foreground">
          Live status is driven by bridge heartbeat and tick freshness, not cached runtime activity.
        </p>
      </div>

      <LiveStatusRail />
      <BridgeStatusBanner state={state} error={error} bridgeUrl={state?.bridgeUrl || undefined} />
      <MarketOverview />
